...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // 04_composition/children.jsx
  var import_react = __toModule(require_react());
  var ReactDOM = __toModule(require_react_dom());
  function Menu() {
    return /* @__PURE__ */ import_react.default.createElement("nav", {
      className: "mt5 block"
    }, /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement("button", {
      onClick: () => {
      }
    }, "AAA"), /* @__PURE__ */ import_react.default.createElement("button", {
      onClick: () => {
      }
    }, "BBB")));
  }
  ReactDOM.render(/* @__PURE__ */ import_react.default.createElement(Menu, null), document.querySelector("#root"));
})();
/*
object-assign
(c) Sindre Sorhus
